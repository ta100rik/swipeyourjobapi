...
public class BaseDaoConnectionPoolingMySQL {
    ...
    private String url = "jdbc:mysql://localhost:3306/likeservice?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
